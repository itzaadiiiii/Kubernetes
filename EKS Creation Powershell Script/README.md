...
Before running Change this line:

$SSHKeyName = "YourKeyPair"

to your actual EC2 Key Pair name, for example:

$SSHKeyName = "my-eks-key"
...
For a more production-grade EKS setup, I would avoid several of those broad node-group permissions such as:
...
and instead use least-privilege IAM roles, IRSA / EKS Pod Identity, and dedicated service accounts for controllers such as AWS Load Balancer Controller and ExternalDNS.

If you're using this as your Day 15 learning lab, though, the script above reproduces your documented setup closely.
